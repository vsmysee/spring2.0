...
public abstract class TagUtils {
	 ...
	 * 'page' or 'application', the method will return {@link javax.servlet.jsp.PageContext#PAGE_SCOPE}.
	 * @param scope the <code>String</code> to inspect
	 * @return the scope found, or {@link javax.servlet.jsp.PageContext#PAGE_SCOPE} if no scope matched
	...
	/**
	 * Determine whether the supplied {@link javax.servlet.jsp.tagext.Tag} has any ancestor tag
	 * of the supplied type.
	 * @param tag the tag whose ancestors are to be checked
	 * @param ancestorTagClass the ancestor {@link Class} being searched for
	 * @return <code>true</code> if the supplied {@link javax.servlet.jsp.tagext.Tag} has any ancestor tag
	 * of the supplied type
	 ...
	 * the {@link javax.servlet.jsp.tagext.Tag} class
	 */
	 ...
	 * type-assignable to the {@link javax.servlet.jsp.tagext.Tag} class
