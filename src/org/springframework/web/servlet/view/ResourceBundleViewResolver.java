 ...
 * that uses bean definitions in a {@link java.util.ResourceBundle}, specified by
 * the bundle basename.
 * 
 ...
 *
 * <p>Note: this <code>ViewResolver</code> implements the {@link org.springframework.core.Ordered}
...
public class ResourceBundleViewResolver extends AbstractCachingViewResolver implements Ordered, DisposableBean {
	...
	/**
	 * Initialize the {@link org.springframework.beans.factory.BeanFactory} from the <code>ResourceBundle</code>,
	 * for the given {@link java.util.Locale locale}.
	...
	/**
	 * Obtain the resource bundle for the given basename and {@link java.util.Locale}.
