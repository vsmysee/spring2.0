...
public class ConfigurableJasperReportsView extends AbstractJasperReportsSingleFormatView {
	...
	/**
	 * Set the {@link net.sf.jasperreports.engine.JRExporter} implementation <code>Class</code> to use. Throws
	 * {@link IllegalArgumentException} if the <code>Class</code> doesn't implement
	 * {@link net.sf.jasperreports.engine.JRExporter}. Required setting, as it does not have a default.
	 */
	...
	/**
	 * Specifies whether or not the {@link net.sf.jasperreports.engine.JRExporter} writes to the {@link java.io.PrintWriter}
	...
	/**
	 * Indicates how the {@link net.sf.jasperreports.engine.JRExporter} should render its data.
