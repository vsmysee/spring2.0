...
public abstract class AbstractJasperReportsView extends AbstractUrlBasedView {
	 ...
	 * {@link net.sf.jasperreports.engine.JRExporterParameter}. The default implementation simply converts the Strings '<code>true</code>' and
	 ...
	 * @throws java.sql.SQLException if there is an error when populating the report using
	 * the <code>javax.sql.DataSource</code>
	 * @throws net.sf.jasperreports.engine.JRException if there is an error when populating the report using
