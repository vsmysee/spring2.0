 ...
 * 
 * <p>Subclasses typically must provide the {@link javax.xml.transform.Source} to transform
 ...
 * 	a {@link org.springframework.core.io.Resource} pointing to the XSLT stylesheet
 ...
 * 	the {@link javax.xml.transform.URIResolver} to be used in the transform
 * <li>{@link #setErrorListener(javax.xml.transform.ErrorListener) errorListener} (optional):
 * 	the {@link javax.xml.transform.ErrorListener} implementation instance for custom handling of warnings and errors during TransformerFactory operations
...
public abstract class AbstractXsltView extends AbstractView {
	 ...
	 * <p>If the {@link javax.xml.transform.TransformerFactory} used by this instance has already
	 * been initialized then invoking this setter will result in the
	 * {@link javax.xml.transform.TransformerFactory#newTemplates(javax.xml.transform.Source) attendant templates}
	 * being re-cached.
	 ...
	 * <p>Only used if we're not passed a single {@link org.w3c.dom.Node} as the model.
     ...
     * @throws org.springframework.context.ApplicationContextException if the stylesheet resource could not be loaded
	 */
	...
	/**
	 * Return the XML {@link javax.xml.transform.Source} to transform.
	 ...
	 * @return a Map of parameters to apply to the transformation process
	 * @see #getParameters(javax.servlet.http.HttpServletRequest)
	 * @see javax.xml.transform.Transformer#setParameter
	 */
