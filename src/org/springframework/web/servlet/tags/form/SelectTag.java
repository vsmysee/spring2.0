 ...
 * approaches supported by the {@link org.springframework.web.servlet.tags.form.OptionWriter} class.
 *
 * <p>Also supports the use of nested {@link org.springframework.web.servlet.tags.form.OptionTag OptionTags} or
 * (typically one) nested {@link org.springframework.web.servlet.tags.form.OptionsTag}.
 *
 * @author Rob Harrop
 * @since 2.0
 * @see org.springframework.web.servlet.tags.form.OptionTag
 * @see org.springframework.web.servlet.tags.form.OptionWriter
 */
public class SelectTag extends AbstractHtmlInputElementTag {

	/**
	 * The {@link javax.servlet.jsp.PageContext} attribute under
	 * which the bound value is exposed to inner {@link org.springframework.web.servlet.tags.form.OptionTag OptionTags}.
	 */
	 ...
	 * <p>Only used in conjunction with nested {@link org.springframework.web.servlet.tags.form.OptionTag OptionTags}.
	 */
	private TagWriter tagWriter;


	/**
	 * Sets the {@link java.util.Collection}, {@link java.util.Map} or array of objects used to
	 * generate the inner '<code>option</code>' tags.
	 * <p>Required when wishing to render '<code>option</code>' tags from
	 * an array, {@link java.util.Collection} or {@link java.util.Map}.
	 ...
	 * bound value for the nested {@link org.springframework.web.servlet.tags.form.OptionTag OptionTags}.
	 */
	...
	/**
	 * Returns '<code>true</code>' for arrays, {@link java.util.Collection Collections}
	 * and {@link java.util.Map Maps}.
	 */
	 ...
	 * nested {@link org.springframework.web.servlet.tags.form.OptionTag options}.
	 */
