...
/**
 * Utility class for testing whether a candidate value matches a {@link org.springframework.web.servlet.support.BindStatus#getValue data bound value}.
 * Eagerly attempts to prove a comparison through a number of avenues to deal with issues such as instance
 * inequality, logical (String-representation-based) equality and {@link java.beans.PropertyEditor}-based comparison.
 *
 * <p>Full support is provided for comparing arrays, {@link java.util.Collection Collections} and {@link java.util.Map Maps}.
 * 
 ...
 * than disprove it.
 * 
 * <p>Special support is given for instances of {@link org.springframework.core.enums.LabeledEnum} with a <code>String</code>-based
 * comparison of the candidate value against the code of the {@link org.springframework.core.enums.LabeledEnum}. This can be useful when a
 * {@link org.springframework.core.enums.LabeledEnum} is used to define a list of '<code>&lt;option&gt;</code>' elements in HTML.
 *
 ...
 * result of applying the corresponding {@link java.beans.PropertyEditor} to the candidate. This comparison may be
...
abstract class SelectedValueComparator {
	 ...
	 * the supplied {@link org.springframework.web.servlet.support.BindStatus}. Equality in this case differs from standard Java equality and
