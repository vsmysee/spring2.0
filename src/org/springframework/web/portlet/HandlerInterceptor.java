 ...
 * @author John A. Lewis
 * @since 2.0
 * @see org.springframework.web.portlet.HandlerExecutionChain#getInterceptors
...
public interface HandlerInterceptor {
	 ...
	 * to handle an {@link javax.portlet.ActionRequest}, but before said HandlerAdapter actually
	 * invokes the handler.
	 * <p>{@link org.springframework.web.portlet.DispatcherPortlet} processes a handler in an execution chain,
	 ...
	 * <p>Called after a HandlerMapping determines an appropriate handler object
	 * to handle a {@link javax.portlet.RenderRequest}, but before said HandlerAdapter actually
	 * invokes the handler.
	 * <p>{@link org.springframework.web.portlet.DispatcherPortlet} processes a handler in an execution chain,
	 * consisting of any number of interceptors, with the handler itself at the end.
	 * With this method, each interceptor can decide to abort the execution chain,
	...
	/**
	 * Intercept the execution of a handler in the render phase.
	 * <p>Called after a {@link org.springframework.web.portlet.HandlerAdapter} actually invoked the handler, but
