...
public abstract class GenericPortletBean extends GenericPortlet {
	 ...
	 * @throws javax.portlet.PortletException if bean properties are invalid (or required
	...
	private static class PortletConfigPropertyValues extends MutablePropertyValues {
		 ...
		 * @throws javax.portlet.PortletException if any required properties are missing
		 */
