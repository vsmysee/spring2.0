 ...
 * date strings. </li>
 * <li>The {@link org.springframework.web.portlet.bind.PortletRequestDataBinder PortletRequestDataBinder}
 * gets applied to populate the new form object with initial request parameters and the
 * {@link #onBindOnNewForm(javax.portlet.RenderRequest, Object, org.springframework.validation.BindException)} callback method is invoked.
 ...
 * <li>Call to {@link #showForm(javax.portlet.RenderRequest, javax.portlet.RenderResponse,
		* org.springframework.validation.BindException) showForm} to return a View that should be rendered
 ...
 * org.springframework.web.portlet.bind.PortletRequestDataBinder PortletRequestDataBinder} gets applied to populate
 ...
 * and register corresponding errors via the given {@link org.springframework.validation.Errors Errors}
 * object.</li>
 ...
 * {@link javax.portlet.ActionResponse#sendRedirect ActionResponse.sendRedirect}.
 * This is important because some methods may not be called before
 * {@link javax.portlet.ActionResponse#sendRedirect ActionResponse.sendRedirect} (e.g.
 * {@link javax.portlet.ActionResponse#setRenderParameter ActionResponse.setRenderParameter}).
...
public abstract class AbstractFormController extends BaseCommandController {
	 ...
	 * {@link javax.portlet.ActionResponse#sendRedirect}.
	 * This information is important because some methods may not be called
	 * before {@link javax.portlet.ActionResponse#sendRedirect}, e.g.
	 * {@link javax.portlet.ActionResponse#setRenderParameter} and
	 * {@link javax.portlet.ActionResponse#setRenderParameters}.
	...
	/**
	 * Return if {@link javax.portlet.ActionResponse#sendRedirect} is
	 ...
	 * @see #onBindOnNewForm(javax.portlet.RenderRequest, Object)
	 * @see #setBindOnNewForm
	 */
	 ...
	 * @param command the command object to perform further binding on
	 * @throws Exception in case of invalid state or arguments
	 * @see #onBindOnNewForm(javax.portlet.RenderRequest, Object, org.springframework.validation.BindException)
	 ...
	 * @throws Exception in case of invalid state or arguments
	 * @see #showForm(javax.portlet.RenderRequest, org.springframework.validation.BindException, String)
	 ...
	 * @return the prepared form view
	 * @throws Exception in case of invalid state or arguments
	 * @see #showForm(javax.portlet.RenderRequest, org.springframework.validation.BindException, String, java.util.Map)
	 * @see #showForm(javax.portlet.RenderRequest, javax.portlet.RenderResponse, org.springframework.validation.BindException)
	 */
