...
public class Perl5RegexpMethodPointcut extends AbstractRegexpMethodPointcut { 
	...
	/**
	 * Initializes the {@link org.apache.oro.text.regex.Pattern ORO representation} of the supplied exclusion patterns.
	 */
	...
	/**
	 * Returns <code>true</code> if the {@link org.apache.oro.text.regex.Pattern} at index <code>patternIndex</code>
	...
	/**
	 * Returns <code>true</code> if the exclusion {@link org.apache.oro.text.regex.Pattern} at index <code>patternIndex</code>
	 * matches the supplied candidate <code>String</code>.
	 */
	...
	/**
	 * Compiles the supplied pattern sources into a {@link org.apache.oro.text.regex.Pattern} array.
	 */
