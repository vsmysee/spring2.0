...
public abstract class JRubyScriptUtils {
	 ...
	 * @throws org.jruby.exceptions.JumpException in case of JRuby parsing failure
	 */
    ...
    /**
	 * Given the root {@link org.jruby.ast.Node} in a JRuby AST will locate the name of the class defined
	 * by that AST.
	...
	/**
	 * Finds the first {@link org.jruby.ast.ClassNode} under the supplied {@link org.jruby.ast.Node}. Returns
	 * '<code>null</code>' if no {@link org.jruby.ast.ClassNode} is found.
	 */
