...
public class SQLErrorCodeSQLExceptionTranslator implements SQLExceptionTranslator {
	 ...
	 * @param dataSource DataSource to use to find metadata and establish
	 * which error codes are usable
	 * @see org.springframework.jdbc.support.SQLErrorCodesFactory#getErrorCodes(javax.sql.DataSource)
	 * @see java.sql.DatabaseMetaData#getDatabaseProductName()
	 */
	 ...
	 * to get the metadata.
	 * @param dbName the database product name that identifies the error codes entry
	 * @see org.springframework.jdbc.support.SQLErrorCodesFactory#getErrorCodes(String)
	 * @see java.sql.DatabaseMetaData#getDatabaseProductName()
	 */
	 ...
	 * @see org.springframework.jdbc.support.CustomSQLErrorCodesTranslation#setExceptionClass
	 */
