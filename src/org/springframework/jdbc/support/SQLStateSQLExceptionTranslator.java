...
/**
 * {@link org.springframework.jdbc.support.SQLExceptionTranslator} implementation that analyzes the SQL state
 * in the {@link java.sql.SQLException}.
 * 
 ...
 * For more precise translation, consider {@link org.springframework.jdbc.support.SQLErrorCodeSQLExceptionTranslator}.
 *
 * @author Rod Johnson
...
public class SQLStateSQLExceptionTranslator implements SQLExceptionTranslator {
	...
	/**
	 * Gets the SQL state code from the supplied {@link java.sql.SQLException exception}.
	 ...
	 * @param ex the exception from which the {@link java.sql.SQLException#getSQLState() SQL state} is to be extracted
