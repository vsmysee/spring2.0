...
public abstract class RdbmsOperation implements InitializingBean {
	 ...
	 * @throws org.springframework.dao.InvalidDataAccessApiUsageException if the operation is already compiled
	 */
	 ...
	 * @throws org.springframework.dao.InvalidDataAccessApiUsageException if the subclass
	 ...
	 * @throws org.springframework.dao.InvalidDataAccessApiUsageException if the parameters are invalid
	 */
