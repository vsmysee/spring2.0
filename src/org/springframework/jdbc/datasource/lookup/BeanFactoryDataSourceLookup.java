...
/**
 * {@link DataSourceLookup} implementation based on a Spring {@link org.springframework.beans.factory.BeanFactory}.
 * 
...
public class BeanFactoryDataSourceLookup implements DataSourceLookup, BeanFactoryAware {
	...
	/**
	 * Create a new instance of the {@link org.springframework.jdbc.datasource.lookup.BeanFactoryDataSourceLookup} class.
	 ...
	 * by a Spring IoC container, as the supplied {@link org.springframework.beans.factory.BeanFactory} will be
	 * replaced by the {@link org.springframework.beans.factory.BeanFactory} that creates it (c.f. the
	 * {@link org.springframework.beans.factory.BeanFactoryAware} contract). So only use this constructor if you
	 * are using this class outside the context of a Spring IoC container. 
	 * @param beanFactory the bean factory to be used to lookup {@link javax.sql.DataSource DataSources}
	 */
