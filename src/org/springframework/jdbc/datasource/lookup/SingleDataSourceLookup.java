...
public class SingleDataSourceLookup implements DataSourceLookup {
	...
	/**
	 * Create a new instance of the {@link org.springframework.jdbc.datasource.lookup.SingleDataSourceLookup} class.
	 * @param dataSource the single {@link javax.sql.DataSource} to wrap
	 */
