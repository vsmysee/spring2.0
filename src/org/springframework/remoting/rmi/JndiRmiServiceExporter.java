 ...
 * @see #setJndiName
 * @see org.springframework.remoting.rmi.JndiRmiClientInterceptor
 * @see org.springframework.remoting.rmi.JndiRmiProxyFactoryBean
...
public class JndiRmiServiceExporter extends RmiBasedExporter implements InitializingBean, DisposableBean {
	 ...
	 * @throws javax.naming.NamingException if service binding failed
	 * @throws java.rmi.RemoteException if service export failed
	 */
