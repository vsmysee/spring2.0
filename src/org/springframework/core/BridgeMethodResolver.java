...
/**
 * Helper for resolving synthetic {@link java.lang.reflect.Method#isBridge bridge Methods} to the
 * {@link java.lang.reflect.Method} being bridged.
 *
 * <p>Given a synthetic {@link java.lang.reflect.Method#isBridge bridge Method} returns the {@link java.lang.reflect.Method}
 * being bridged. A bridge method may be created by the compiler when extending a
 * parameterized type whose methods have parameterized arguments. During runtime
 * invocation the bridge {@link java.lang.reflect.Method} may be invoked and/or used via reflection.
 * When attempting to locate annotations on {@link java.lang.reflect.Method Methods}, it is wise to check
 * for bridge {@link java.lang.reflect.Method Methods} as appropriate and find the bridged {@link java.lang.reflect.Method}.
 *
...
public abstract class BridgeMethodResolver {
	...
	/**
	 * Find the original method for the supplied {@link java.lang.reflect.Method bridge Method}.
	 * <p>It is safe to call this method passing in a non-bridge {@link java.lang.reflect.Method} instance.
	 * In such a case, the supplied {@link java.lang.reflect.Method} instance is returned directly to the caller.
	 ...
	 * consider a validate candidate for the {@link java.lang.reflect.Method} that is {@link java.lang.reflect.Method#isBridge() bridged}
	 * by the supplied {@link java.lang.reflect.Method bridge Method}. This method performs inexpensive
	...
	/**
	 * Determine whether or not the bridge {@link java.lang.reflect.Method} is the bridge for the
	 * supplied candidate {@link java.lang.reflect.Method}.
	 */
	...
	/**
	 * Search for the generic {@link java.lang.reflect.Method} declaration whose erased signature
	...
	/**
	 * Return <code>true</code> if the {@link java.lang.reflect.Type} signature of both the supplied
	 * {@link java.lang.reflect.Method#getGenericParameterTypes() generic Method} and concrete {@link java.lang.reflect.Method}
	 * are equal after resolving all {@link java.lang.reflect.TypeVariable TypeVariables} using the supplied
	...
	/**
	 * If the supplied {@link Class} has a declared {@link java.lang.reflect.Method} whose signature matches
	 * that of the supplied {@link java.lang.reflect.Method}, then this matching {@link java.lang.reflect.Method} is returned,
	...
	/**
	 * Extracts the bound '<code>Class</code>' for a give {@link java.lang.reflect.TypeVariable}.
	 */
