...
public interface SqlMapClientOperations {
	...
	/**
	 * @see com.ibatis.sqlmap.client.SqlMapExecutor#queryWithRowHandler(String, com.ibatis.sqlmap.client.event.RowHandler)
	 * @throws org.springframework.dao.DataAccessException in case of errors
	 */
	...
	/**
	 * @see com.ibatis.sqlmap.client.SqlMapExecutor#queryWithRowHandler(String, Object, com.ibatis.sqlmap.client.event.RowHandler)
	 * @throws org.springframework.dao.DataAccessException in case of errors
	 */
