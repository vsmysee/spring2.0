...
public abstract class PersistenceManagerFactoryUtils {
	 ...
	 * @throws org.springframework.dao.DataAccessResourceFailureException if the PersistenceManager couldn't be obtained
	 ...
	 * when no transactional PersistenceManager can be found for the current thread
	 * @return the PersistenceManager
	 * @throws javax.jdo.JDOException if the PersistenceManager couldn't be created
	 * @throws IllegalStateException if no thread-bound PersistenceManager found and
	 * "allowCreate" is <code>false</code>
	 ...
	 * @see org.springframework.orm.jdo.JdoDialect#applyQueryTimeout
	 */
	 ...
	 * @see org.springframework.orm.jdo.JdoAccessor#convertJdoAccessException
	 * @see org.springframework.orm.jdo.JdoTransactionManager#convertJdoAccessException
	 * @see org.springframework.orm.jdo.JdoDialect#translateException
	 */
	 ...
	 * @param pmf PersistenceManagerFactory that the PersistenceManager was created with
	 * (can be <code>null</code>)
	 * @throws javax.jdo.JDOException if thrown by JDO methods
	 */
