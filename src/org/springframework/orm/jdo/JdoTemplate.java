 ...
 * @see org.springframework.orm.jdo.JdoCallback
...
public class JdoTemplate extends JdoAccessor implements JdoOperations {
	 ...
	 * @see #execute(org.springframework.orm.jdo.JdoCallback, boolean)
	 * @see #prepareQuery
	 */
	 ...
	 * @throws javax.jdo.JDOException if the query could not be properly prepared
	 * @see org.springframework.orm.jdo.JdoCallback#doInJdo
