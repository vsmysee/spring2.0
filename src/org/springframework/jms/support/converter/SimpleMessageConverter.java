...
public class SimpleMessageConverter implements MessageConverter {
	...
	/**
	 * Extract a byte array from the given {@link javax.jms.BytesMessage}.
	 * @param message the message to convert
	...
	/**
	 * Extract a Map from the given {@link javax.jms.MapMessage}.
	 * @param message the message to convert
	...
	/**
	 * Extract a Serializable object from the given {@link javax.jms.ObjectMessage}.
	 * @param message the message to convert
