...
/**
 * Simple {@link org.springframework.jms.support.destination.DestinationResolver} implementation resolving destination names
...
public class DynamicDestinationResolver implements DestinationResolver {
	...
	/**
	 * Resolve the given destination name to a {@link javax.jms.Topic}.
	 * @param session the current JMS Session
	 * @param topicName the name of the desired {@link javax.jms.Topic}
	 * @return the JMS {@link javax.jms.Topic}
	 * @throws javax.jms.JMSException if resolution failed
	...
	/**
	 * Resolve the given destination name to a {@link javax.jms.Queue}.
	 * @param session the current JMS Session
	 * @param queueName the name of the desired {@link javax.jms.Queue}
	 * @return the JMS {@link javax.jms.Queue}
	 * @throws javax.jms.JMSException if resolution failed
