...
public class JmsDestinationAccessor extends JmsAccessor {
	...
	/**
	 * Resolve the given destination name into a JMS {@link javax.jms.Destination},
	 * via this accessor's {@link org.springframework.jms.support.destination.DestinationResolver}.
	 * @param session the current JMS {@link javax.jms.Session}
