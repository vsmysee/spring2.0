 ...
 * 
 * <p>To be used with the {@link org.springframework.jms.core.JmsTemplate#execute(org.springframework.jms.core.ProducerCallback)}
 * method, often implemented as an anonymous inner class.
 *
 * <p>The typical implementation will perform multiple operations on the
 * supplied JMS {@link javax.jms.Session} and {@link javax.jms.MessageProducer}. When used with
 ...
 * @author Mark Pollack
 * @since 1.1
 * @see org.springframework.jms.core.JmsTemplate#execute(org.springframework.jms.core.ProducerCallback)
 */
