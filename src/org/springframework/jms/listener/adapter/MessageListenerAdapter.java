 ...
 * the raw {@link javax.jms.Message}. Message type conversion is delegated to a Spring
 ...
 * Spring message listener container). Usage as standard JMS {@link javax.jms.MessageListener}
 ...
 * {@link org.springframework.jms.listener.adapter.MessageListenerAdapter} sending a {@link javax.jms.TextMessage} in response.
 * 
...
public class MessageListenerAdapter implements MessageListener, SessionAwareMessageListener {
	...
	/**
	 * Create a new {@link org.springframework.jms.listener.adapter.MessageListenerAdapter} with default settings.
	 */
	...
	/**
	 * Create a new {@link org.springframework.jms.listener.adapter.MessageListenerAdapter} for the given delegate.
	 */
	...
	/**
	 * Standard JMS {@link javax.jms.MessageListener} entry point.
	 ...
	 * <p>This method only applies when used as standard JMS {@link javax.jms.MessageListener}.
	 ...
	 * {@link javax.jms.Destination} of the supplied request; if that is not <code>null</code>
	 ...
	 * @throws javax.jms.JMSException if thrown by JMS API methods
	 * @throws javax.jms.InvalidDestinationException if no {@link javax.jms.Destination} can be determined
	 * @see #setDefaultResponseDestination
	...
	/**
	 * Resolve the default response destination into a JMS {@link javax.jms.Destination}, using this
	 * accessor's {@link DestinationResolver} in case of a destination name.
	 * @return the located {@link javax.jms.Destination}
