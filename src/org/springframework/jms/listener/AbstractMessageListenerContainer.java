 ...
 *
 * <p>Usually holds a single JMS {@link javax.jms.Connection} that all listeners are
...
public abstract class AbstractMessageListenerContainer extends JmsDestinationAccessor
	 ...
	 * {@link javax.jms.Destination} type; c.f. {@link #setDestinationName(String)
	 ...
	 * <p>Alternatively, specify a JMS {@link javax.jms.Destination} object as "destination".
	 ...
	 * {@link String} type; c.f. {@link #setDestination(javax.jms.Destination) when
	 ...
	 * This can be either a standard JMS {@link javax.jms.MessageListener} object
	 * or a Spring {@link SessionAwareMessageListener} object.
	 * @throws IllegalArgumentException if the supplied listener is not a
	 * {@link javax.jms.MessageListener} or a {@link SessionAwareMessageListener}
	 * @see javax.jms.MessageListener
	 * @see SessionAwareMessageListener
	 */
	 ...
	 * <p>By default, only a standard JMS {@link javax.jms.MessageListener} object or a
	 ...
	 * the listener's {@link javax.jms.Session}.
	 * <p>Turn this off to expose a fresh JMS Session fetched from the same
	 * underlying JMS {@link javax.jms.Connection} instead, which might be necessary
	...
	/**
	 * Return whether to expose the listener JMS {@link javax.jms.Session} to a
	 ...
	 * and starts the {@link javax.jms.Connection}
	 ...
	 * @throws javax.jms.JMSException if the preparation efforts failed
	 * @see #setClientId
	 */
	 ...
	 * listener container.
	 * @throws org.springframework.jms.JmsException if shutdown failed
	 * @see #destroyListener()
	 */
	 ...
	 * @throws org.springframework.jms.JmsException if starting failed
	 * @see #doStart
	 */
	 ...
	 * @throws org.springframework.jms.JmsException if stopping failed
	 * @see #doStop
	 */
	 ...
	 * @throws javax.jms.JMSException if registration failed
	 ...
	 * <p>Subclasses need to implement this method for their specific
	 * listener management process.
	 * @throws javax.jms.JMSException if destruction failed
	 */
