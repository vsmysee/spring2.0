...
/**
 * {@link org.springframework.beans.factory.config.BeanFactoryPostProcessor} implementation that allows for convenient
 * registration of custom {@link java.beans.PropertyEditor property editors}.
 *
 ...
 * @see org.springframework.beans.factory.config.ConfigurableBeanFactory#addPropertyEditorRegistrar
 * @see org.springframework.beans.factory.config.ConfigurableBeanFactory#registerCustomEditor
...
public class CustomEditorConfigurer implements BeanFactoryPostProcessor, BeanClassLoaderAware, Ordered {
	 ...
	 * @see org.springframework.beans.factory.config.ConfigurableListableBeanFactory#addPropertyEditorRegistrar
	 */
	...
	/**
	 * Specify the custom editors to register via a {@link java.util.Map}, using the
	 * class name of the required type as the key and the {@link java.beans.PropertyEditor}
	 * instance as the value.
	 * @param customEditors said <code>Map</code> of editors (can be <code>null</code>) 
	 * @see org.springframework.beans.factory.config.ConfigurableListableBeanFactory#registerCustomEditor
	 */
