 ...
 * original.
 *
 * <p>{@link org.springframework.beans.factory.xml.BeanDefinitionDecorator BeanDefinitionDecorators} should be aware that
 * they may be part of a chain. In particular, a {@link org.springframework.beans.factory.xml.BeanDefinitionDecorator} should
 * be aware that a previous {@link org.springframework.beans.factory.xml.BeanDefinitionDecorator} may have replaced the
 ...
 *
 * <p>{@link org.springframework.beans.factory.xml.BeanDefinitionDecorator BeanDefinitionDecorators} that wish to add an
 ...
 *
 * <p>The parser locates a {@link org.springframework.beans.factory.xml.BeanDefinitionDecorator} from the
...
public interface BeanDefinitionDecorator {
	...
	/**
	 * Parse the specified {@link org.w3c.dom.Node} (either an element or an attribute) and decorate
