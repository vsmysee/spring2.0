...
public abstract class ReflectionUtils {
	...
	/**
	 * Attempts to find a {@link java.lang.reflect.Method} on the supplied type with the supplied name and
	 * parameter types. Searches all superclasses up to <code>Object</code>. Returns
	 * '<code>null</code>' if no {@link java.lang.reflect.Method} can be found.
	 */
	...
	/**
	 * Invoke the specified {@link java.lang.reflect.Method} against the supplied target object with the supplied arguments
	 * The target object can be null when invoking a static {@link java.lang.reflect.Method}.
