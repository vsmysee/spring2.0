...
public class AutoPopulatingList implements List {
	...
	/**
	 * The {@link org.springframework.util.AutoPopulatingList.ElementFactory} to use to create new {@link java.util.List} elements
	 * on demand.
	 */
	...
	/**
	 * Creates a new <code>AutoPopulatingList</code> that is backed by the supplied {@link java.util.List}
	...
	/**
	 * Creates a new <code>AutoPopulatingList</code> that is backed by a standard
	 * {@link java.util.ArrayList} and creates new elements on demand using the supplied {@link org.springframework.util.AutoPopulatingList.ElementFactory}.
	 */
	...
	/**
	 * Creates a new <code>AutoPopulatingList</code> that is backed by the supplied {@link java.util.List}
	 * and creates new elements on demand using the supplied {@link org.springframework.util.AutoPopulatingList.ElementFactory}.
	 */
	...
	public interface ElementFactory {
		 ...
		 * @throws org.springframework.util.AutoPopulatingList.ElementInstantiationException if the instantiation process failed
