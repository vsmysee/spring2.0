 ...
 * registered and unregistered via an {@link org.springframework.jmx.export.MBeanExporter}.
 *
 * @author Rob Harrop
 * @since 1.2.2
...
public interface MBeanExporterListener {
	...
	/**
	 * Called by {@link org.springframework.jmx.export.MBeanExporter} after an MBean has been <i>successfully</i>
