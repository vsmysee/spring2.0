 ...
 * supplied {@link org.springframework.jmx.export.assembler.MBeanInfoAssembler} implementation.
 *
...
public class MBeanExporter extends MBeanRegistrationSupport
	...
	/**
	 * Autodetection mode indicating that only the {@link org.springframework.jmx.export.assembler.MBeanInfoAssembler} should be able
	 * to autodetect beans.
	 */
	...
	/**
	 * Indicates whether Spring should modify generated {@link javax.management.ObjectName ObjectNames}
	 */
	...
	/**
	 * Indicates whether Spring should ensure that {@link javax.management.ObjectName ObjectNames} generated by
	...
	/**
	 * Set the {@link javax.management.NotificationListener NotificationListeners} to register with the
	...
	/**
	 * Register the configured {@link javax.management.NotificationListener NotificationListeners}
	 * with the {@link javax.management.MBeanServer}.
	 */
	 ...
	 * {@link javax.management.NotificationListener} should be registered.
	 */
	 ...
	 * registration of the MBean identified by the supplied {@link javax.management.ObjectName}.
	 */
	...
	/**
	 * Notifies all registered {@link MBeanExporterListener MBeanExporterListeners} of the
	 * unregistration of the MBean identified by the supplied {@link javax.management.ObjectName}.
	 */
	...
	/**
	 * Extension of {@link org.springframework.aop.target.LazyInitTargetSource} that will inject a
