 ...
 *
 * <p>Provides Spring-created managed resources with a {@link org.springframework.jmx.export.notification.NotificationPublisher}
 * as soon as they are registered with the {@link javax.management.MBeanServer}.
 *
 * @author Rob Harrop
 * @since 2.0
 * @see org.springframework.jmx.export.notification.NotificationPublisher
 */
public interface NotificationPublisherAware {

	/**
	 * Set the {@link org.springframework.jmx.export.notification.NotificationPublisher} instance for the current managed resource instance.
	 */
