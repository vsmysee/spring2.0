...
/**
 * Builds on the {@link org.springframework.jmx.export.assembler.AbstractMBeanInfoAssembler} superclass to
...
public abstract class AbstractReflectiveMBeanInfoAssembler extends AbstractMBeanInfoAssembler {
	...
	/**
	 * Identifies a getter method in a JMX {@link javax.management.Descriptor}.
	 */
	protected static final String FIELD_GET_METHOD = "getMethod";

	/**
	 * Identifies a setter method in a JMX {@link javax.management.Descriptor}.
	 */
	protected static final String FIELD_SET_METHOD = "setMethod";

	/**
	 * Constant identifier for the role field in a JMX {@link javax.management.Descriptor}.
	 */
	protected static final String FIELD_ROLE = "role";

	/**
	 * Constant identifier for the getter role field value in a JMX {@link javax.management.Descriptor}.
	 */
	protected static final String ROLE_GETTER = "getter";

	/**
	 * Constant identifier for the setter role field value in a JMX {@link javax.management.Descriptor}.
	 */
	protected static final String ROLE_SETTER = "setter";

	/**
	 * Identifies an operation (method) in a JMX {@link javax.management.Descriptor}.
	 */
	protected static final String ROLE_OPERATION = "operation";

	/**
	 * Constant identifier for the visibility field in a JMX {@link javax.management.Descriptor}.
	 */
	 ...
	 * @throws javax.management.JMException in case of errors
	 * @see #populateAttributeDescriptor
	 */
