...
public class ConnectorServerFactoryBean extends MBeanRegistrationSupport
	 ...
	 * @throws javax.management.MalformedObjectNameException if the <code>ObjectName</code> is malformed
	 */
	 ...
	 * @throws javax.management.JMException if a problem occured when registering the connector server
	 * with the <code>MBeanServer</code>
	 * @throws java.io.IOException if there is a problem starting the connector server
	 */
	 ...
	 * @throws java.io.IOException if there is an error stopping the connector server
	 */
