...
public class MBeanServerConnectionFactoryBean implements FactoryBean, InitializingBean, DisposableBean {
	 ...
	 * environment properties
	 * @see org.springframework.jmx.support.MBeanServerConnectionFactoryBean#setServiceUrl(String)
	 * @see org.springframework.jmx.support.MBeanServerConnectionFactoryBean#setEnvironment(java.util.Properties)
	 */
