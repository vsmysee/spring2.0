...
public class ObjectNameManager {
	 ...
	 * @throws javax.management.MalformedObjectNameException in case of an invalid object name specification
	 ...
	 * @return the <code>ObjectName</code> instance
	 * @throws javax.management.MalformedObjectNameException in case of an invalid object name specification
	 * @see javax.management.ObjectName#ObjectName(String, String, String)
	 * @see javax.management.ObjectName#getInstance(String, String, String)
	 */
	 ...
	 * @return the <code>ObjectName</code> instance
	 * @throws javax.management.MalformedObjectNameException in case of an invalid object name specification
	 * @see javax.management.ObjectName#ObjectName(String, java.util.Hashtable)
	 * @see javax.management.ObjectName#getInstance(String, java.util.Hashtable)
	 */
