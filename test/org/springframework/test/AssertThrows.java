 ...
 * {@link org.springframework.test.AssertThrows} class like so:
 * 
 ...
 * </pre>
 * 
 * <p>If the <b>wrong</b> type of {@link Exception} was thrown, the
 ...
 * </pre>
 * 
 * <p>The test for the correct {@link Exception} respects polymorphism,
...
public abstract class AssertThrows {
    ...
    /**
	 * Creates a new instance of the {@link org.springframework.test.AssertThrows} class.
	 ...
	 * @throws IllegalArgumentException if the supplied <code>expectedException</code> is
		 * <code>null</code>; or if said argument is not an {@link Exception}-derived class
	 */
	...
	/**
	 * Return the {@link Exception} expected to be thrown during
	 ...
	 * resulting (expected) {@link Exception}.
	 * @see #test() 
	 * @see #doFail()
	 ...
	 * {@link Exception} is <b>not</b> thrown.
	 ...
	 * @param actualException the {@link Exception} that has been thrown in the body of a test method (will never be <code>null</code>)
	 */
	 ...
	 * of {@link Exception} is thrown in the body of the test.
